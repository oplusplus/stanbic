...
<!-- Mirrored from sun-themes.com/html/fooday/homepage2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 02:56:47 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="page-container">
          <div class="top-header top-slider">
            <div class="slides">
              <div class="slide-content slide-layout-01">
                <div class="swin-sc swin-sc-title"><img src="assets/images/slider/slider1-icon.png" data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="500" alt="" class="slide-icon animated fadeInUp">
                  <p data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="800" class="top-title animated fadeInUp"><span>Welcome to FOODAY restaurant</span></p>
                  <h3 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1000" class="title animated fadeInUp">Let Enjoy The Rhym Of Fooday Dishes</h3>
                </div>
                <div data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1200" class="btn-wrap text-center animated fadeInUp"><a href="javascript:void(0)" class="btn swin-btn"> <span>Read More</span></a></div>
              </div>
              <div class="slide-bg"><img src="assets/images/slider/slider1-bg1.jpg" alt="" class="img img-responsive"></div>
            </div>
            <div class="slides">
              <div class="slide-content">
                <div class="swin-sc swin-sc-title"><img src="assets/images/slider/slider1-icon.png" data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="500" alt="" class="slide-icon animated">
                  <p data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="800" class="top-title animated"><span>Welcome to FOODAY restaurant</span></p>
                  <h3 data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1000" class="title animated">Let Enjoy The Rhym Of Fooday Dishes</h3>
                </div>
                <div data-ani-in="fadeInUp" data-ani-out="fadeOutDown" data-ani-delay="1200" class="btn-wrap text-center animated"><a href="javascript:void(0)" class="btn swin-btn"> <span>Read More</span></a></div>
              </div>
              <div class="slide-bg"><img src="assets/images/slider/slider1-bg2.jpg" alt="" class="img img-responsive"></div>
            </div>
          </div>
          <div class="page-content-wrapper">
            <div class="page-content no-padding">
                  ...
                  <div class="row">
                    <div class="col-md-5 col-sm-12 col-xs-12">
                      <div class="swin-sc swin-sc-title text-left wow fadeInUp">
                        ...
                        <h3 class="title white-color">Fooday Story</h3>
                      </div>
                      <p class="des wow fadeInUp">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do ting eusm tempor incididunt ut labore et dolore magna aliqua. Ut enimin ad minim veniam, quis nostrud exercitation ullamco.</p>
                      <p class="des wow fadeInUp">in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id.</p><a href="javascript:void(0)" class="swin-btn wow fadeInUp"> <span>Read More</span></a>
                    </div>
                    <div class="col-md-7 col-sm-12 col-xs-12">
                      <div class="swin-sc swin-sc-timeline">
                          ...
                          <div class="slides">
                            <div class="timeline-item item">
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-1-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-1.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-2-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-2.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-1-3-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-1-3.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                            </div>
                            <div class="timeline-item item">
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-2-1-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-2-1.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-2-2-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-2-2.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-2-3-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-2-3.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                            </div>
                            <div class="timeline-item item">
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-3-1-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-3-1.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-3-2-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-3-2.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                              <div class="col-sm-4 item-inner">
                                <div class="img-effect"><img src="assets/images/pages/timeline-3-3-thumbnail.jpg" alt="" class="img img-responsive">
                                  <div class="mask"><a href="assets/images/pages/timeline-3-3.jpg" class="magnific-item swipebox">+</a></div>
                                </div>
                              </div>
                            </div>
                            <div class="timeline-item item">
                        ...
                        <div data-width="150" class="nav-slider flexslider">
                          <ul class="slides">
              ...
              <section class="reservation-section-01 ptn pbn">
                <div class="container">
                  <div class="row">
                    <div class="col-md-7">
              ...
              <section class="product-sesction-02 padding-top-120 padding-bottom-100">
                <div class="container">
                  ...
                  <div class="swin-sc swin-sc-product products-02 carousel-02">
                    ...
                    <div class="swin-btn-wrap center btn-load-more"><a href="#" class="swin-btn center btn-transparent"> <span>Load More			</span></a></div>
                  </div>
                </div>
              </section>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="swin-sc swin-sc-title text-left">
                        ...
                        <h3 class="title white-color">Master Chef</h3>
                      </div>
                      <div class="swin-sc swin-sc-team-slider-2">
                            ...
                            <div class="team-item">
                              <div class="team-info clearfix">
                                ...
                                <ul class="socials-nb list-inline">
                                  <li><a href="#" class="swin-transition"><i class="fa fa-facebook"></i></a></li>
                                  <li><a href="#" class="swin-transition"><i class="fa fa-twitter"></i></a></li>
                                  <li><a href="#" class="swin-transition"><i class="fa fa-pinterest"></i></a></li>
                                  <li><a href="#" class="swin-transition"><i class="fa fa-google-plus"></i></a></li>
                                </ul>
                              </div>
                              <p class="team-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis loteit nostrud exercitation.</p>
                            </div>
                            <div class="team-item">
                              <div class="team-info clearfix">
                        ...
                        <div data-width="150" class="nav-slider">
                          <ul class="slides list-inline">
                            <li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/team/team-thumbnail-1.png" alt="fooday" class="img img-responsive swin-transition"></a></li>
                            <li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/team/team-thumbnail-2.png" alt="fooday" class="img img-responsive swin-transition"></a></li>
                            <li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/team/team-thumbnail-3.png" alt="fooday" class="img img-responsive swin-transition"></a></li>
                            <li class="swin-transition"><a href="javascript:void(0)" class="testimonial-nav-item"><img src="assets/images/team/team-thumbnail-4.png" alt="fooday" class="img img-responsive swin-transition"></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
              ...
              <section class="blog-section-02 pbn padding-top-100 padding-bottom-100"><img src="assets/images/background/soup1.png" alt="" class="img-left img-bg img-responsive img-decorate"><img src="assets/images/background/soup2.png" alt="" class="img-right img-bg img-responsive img-decorate">
                <div class="container">
                  <div class="swin-sc swin-sc-title">
                    <p class="top-title"><span>Update From</span></p>
                    <h3 class="title white-color">Our Featured Blog</h3>
                  </div>
                      ...
                      <div class="slides">
                        <div class="blog-item swin-transition">
                          ...
                          <div class="blog-content">
                            ...
                            <p class="blog-description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Utom enimtu ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in lorem ispum nioty reprehenderit in voluptate velit esse cillum dolore eu fugiat.</p>
              ...
              <section class="testimonial-section-02 padding-top-100 padding-bottom-100"><img src="assets/images/background/pizza1.png" alt="" class="img-left img-bg img-responsive img-decorate"><img src="assets/images/background/food1.png" alt="" class="img-right img-bg img-responsive img-decorate">
                <div class="container">
                  <div class="row">
...
<!-- Mirrored from sun-themes.com/html/fooday/homepage2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jan 2021 02:58:46 GMT -->
</html>